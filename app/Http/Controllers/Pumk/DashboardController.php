...
class DashboardController extends Controller
{
    public function index(): Response
    {
        ...
        $stats = $baseQuery->clone()->selectRaw("
            ...
            SUM(CASE WHEN status IN ('submitted','katim_approved','pic_approved','ppk_approved') THEN 1 ELSE 0 END) as proses,
        ...
        $nilaiProses = $baseQuery->clone()->whereIn('status', ['submitted', 'katim_approved', 'pic_approved', 'ppk_approved'])->sum('total_anggaran');
