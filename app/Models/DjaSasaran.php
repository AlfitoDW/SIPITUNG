...
class DjaSasaran extends Model
{
    ...
    public function program(): BelongsTo { return $this->belongsTo(DjaProgram::class, 'program_id'); }
    public function kros(): HasMany      { return $this->hasMany(DjaKro::class, 'sasaran_id'); }
}
