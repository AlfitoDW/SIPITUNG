                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            {dialog.action === 'approve' && `PK Awal dari ${dialog.label} akan disetujui dan terkunci.`}
                            {dialog.action === 'reject'  && `PK Awal dari ${dialog.label} akan ditolak dan dikembalikan ke KetuaTim.`}
                            {dialog.action === 'reopen'  && `PK Awal dari ${dialog.label} akan dibuka kembali ke status draft.`}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
