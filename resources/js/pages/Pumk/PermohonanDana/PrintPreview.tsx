    ...
    return (
        <>
            ...
            <div className="no-print fixed top-4 right-4 z-50 flex gap-2">
                ...
                <button
                    onClick={() => {
                        // window.close() hanya bekerja jika tab dibuka via window.open().
                        // Jika dibuka via target="_blank" (link biasa), pakai history.back()
                        // sebagai fallback agar tetap bisa kembali.
                        try {
                            window.close();
                            // Jika window.close() tidak menutup (tab tidak ditutup dalam 300ms),
