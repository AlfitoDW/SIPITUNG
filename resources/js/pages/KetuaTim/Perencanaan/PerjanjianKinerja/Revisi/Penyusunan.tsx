                                    ...
                                    <div className={`flex items-center justify-between px-4 py-2.5 ${color.sasaranBg}`}>
                                        ...
                                        {isEditable && (
                                            <div className="flex items-center gap-1">
                                                <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => openEditSasaran(sasaran)}><Pencil className="h-3.5 w-3.5" /></Button>
                                                <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive hover:text-destructive" onClick={() => setDeleteDialog({ open: true, type: 'sasaran', id: sasaran.id, label: sasaran.kode })}><Trash2 className="h-3.5 w-3.5" /></Button>
                                            </div>
                                        )}
                                    </div>
                                    <Table className="[&_td]:border-b [&_td]:border-r [&_th]:border-r">
                                        ...
                                        <TableBody>
                                            {sasaran.indikators.length === 0 ? (
                                                <TableRow><TableCell colSpan={isEditable ? 4 : 3} className="text-center text-sm text-muted-foreground py-4">Belum ada indikator</TableCell></TableRow>
                                                    ...
                                                    {isEditable && (
                                                        <TableCell className="text-center">
                                                            <div className="flex items-center justify-center gap-1">
                                                                <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => openEditIndikator(iku)}><Pencil className="h-3.5 w-3.5" /></Button>
                                                                <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive hover:text-destructive" onClick={() => setDeleteDialog({ open: true, type: 'indikator', id: iku.id, label: iku.kode })}><Trash2 className="h-3.5 w-3.5" /></Button>
                                                            </div>
                                                        </TableCell>
                                                    )}
                                                </TableRow>
