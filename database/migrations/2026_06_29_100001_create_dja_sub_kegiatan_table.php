...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('dja_sub_kegiatan')) {
        ...
        if ($this->hasColumns('dja_rincian_biaya', ['kegiatan_id', 'kode_akun', 'nama_akun'])) {
            ...
            foreach ($groups as $idx => $group) {
                ...
                // Upsert agar aman jika deploy sebelumnya gagal setelah insert.
                DB::table('dja_sub_kegiatan')->updateOrInsert(
                    [
        ...
        if (! Schema::hasColumn('dja_rincian_biaya', 'sub_kegiatan_id')) {
        ...
        if (Schema::hasColumn('dja_rincian_biaya', 'sub_kegiatan_id')
            && $this->hasColumns('dja_rincian_biaya', ['kegiatan_id', 'kode_akun', 'nama_akun'])) {
        ...
        if ($this->foreignKeyExists('dja_rincian_biaya', 'kegiatan_id')) {
            Schema::table('dja_rincian_biaya', function (Blueprint $table) {
                $table->dropForeign(['kegiatan_id']);
            });
        }

        if ($this->indexExists('dja_rincian_biaya', 'drb_kegiatan_idx')) {
            Schema::table('dja_rincian_biaya', function (Blueprint $table) {
        ...
        $oldColumns = array_values(array_filter(
            ['kegiatan_id', 'kode_akun', 'nama_akun'],
            fn (string $column): bool => Schema::hasColumn('dja_rincian_biaya', $column)
        ));

        if ($oldColumns !== []) {
            Schema::table('dja_rincian_biaya', function (Blueprint $table) use ($oldColumns) {
        ...
        if (Schema::hasColumn('dja_rincian_biaya', 'sub_kegiatan_id')
            && ! $this->indexExists('dja_rincian_biaya', 'drb_sub_kegiatan_idx')) {
            Schema::table('dja_rincian_biaya', function (Blueprint $table) {
